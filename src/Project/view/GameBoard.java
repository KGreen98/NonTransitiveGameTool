...
public class GameBoard extends JPanel {
    ...
    public void addGameRunListener(Project.controller.Controller.GameRunListener gameRunListener) {
        playGameButton.addActionListener(gameRunListener);
    }

    public void addFindBestOptionListener(Project.controller.FindBestOptionListener findBestOptionListener) {
        findBestOptionButton.addActionListener(findBestOptionListener);
    }

    public void addSimulateListener(Project.controller.SimulateListener simulateListener) {
        simulationRun.addActionListener(simulateListener);
    }

    public void addProbabilityListener(Project.controller.ProbabilityListener probabilityListener) {
